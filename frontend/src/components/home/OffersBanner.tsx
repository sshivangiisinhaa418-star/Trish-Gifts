      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="relative overflow-hidden rounded-[2rem] h-[280px] md:h-[320px] group cursor-pointer shadow-sm hover:shadow-xl transition-all duration-500">
            ...
            <div className="relative z-10 h-full p-6 sm:p-8 md:p-10 flex flex-col justify-center max-w-md">
              <div className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-white/10 backdrop-blur-md rounded-full text-[10px] font-bold text-white uppercase tracking-widest mb-3 sm:mb-4 w-fit border border-white/20">
                <Percent className="w-3 h-3 text-brand-400" />
                Special Offer
              </div>
              
              <h3 className="text-2xl sm:text-3xl md:text-4xl font-heading font-medium text-white mb-2 sm:mb-3 leading-tight">
                Get 20% Off <span className="text-brand-300 italic font-light">Premium</span>
              </h3>
              
              <p className="text-gray-300 text-xs sm:text-sm md:text-base mb-6 sm:mb-8 font-light">
              ...
              <Link href="/discover" className="flex items-center gap-2 text-xs sm:text-sm font-bold text-gray-900 bg-white px-5 sm:px-6 py-2.5 sm:py-3 rounded-full hover:bg-gray-100 transition-colors group/btn w-fit">
                Claim Offer
          ...
          <div className="relative overflow-hidden rounded-[2rem] h-[280px] md:h-[320px] group cursor-pointer shadow-sm hover:shadow-xl transition-all duration-500">
            ...
            <div className="relative z-10 h-full p-6 sm:p-8 md:p-10 flex flex-col justify-center max-w-md">
              ...
              <p className="text-rose-100/80 text-xs sm:text-sm md:text-base mb-6 sm:mb-8 font-light">
                Valid on all orders above ₹2,999. Credited instantly to your account.
              </p>
              
              <Link href="/discover" className="flex items-center gap-2 text-xs sm:text-sm font-bold text-rose-900 bg-white px-5 sm:px-6 py-2.5 sm:py-3 rounded-full hover:bg-rose-50 transition-colors group/btn w-fit">
                Know More
                <ArrowRight className="w-4 h-4 group-hover/btn:translate-x-1 transition-transform" />
              </Link>
            </div>
