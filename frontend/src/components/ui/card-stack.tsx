                ...
                <button
                  ...
                  className={cn(
                    ...
                    on
                      ...
                      : "bg-gray-300 hover:bg-gray-500 dark:bg-gray-700 dark:hover:bg-gray-500",
                  )}
  ...
  return (
    <div className="relative h-full w-full bg-white dark:bg-gray-900">
      ...
      <div className="relative z-10 flex h-full flex-col justify-end p-6">
        {item.tag && (
          <span className="inline-block bg-brand-500 text-white text-[10px] font-bold px-2 py-1 rounded uppercase tracking-wider mb-2 w-max">
            {item.tag}
          </span>
        )}
