        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center px-4 sm:px-8 py-12 lg:py-0">
          ...
          <div className="w-full max-w-lg bg-white/95 backdrop-blur-2xl p-10 md:p-12 rounded-[2.5rem] border border-white/60 shadow-[0_20px_40px_-15px_rgba(0,0,0,0.1)] hover:shadow-[0_30px_60px_-15px_rgba(0,0,0,0.15)] transition-shadow duration-500 animate-fade-up">
            ...
            <form className="space-y-6">
              ...
              <div>
                <div className="flex items-center justify-between mb-2 ml-1">
                  <label className="text-[10px] font-bold text-gray-900 uppercase tracking-[0.2em] block">Password</label>
                  <a href="#" className="text-xs text-[#500000] hover:underline">Forgot Password?</a>
                </div>
              ...
              <button 
                type="button" 
                onClick={() => router.push('/')}
                className="w-full py-4 bg-gray-900 text-white rounded-2xl text-sm font-bold uppercase tracking-widest hover:bg-[#500000] transition-colors mt-6 shadow-lg hover:shadow-xl"
              >
                Sign In
              </button>
            </form>
            ...
            <div className="grid grid-cols-2 gap-4">
              <button className="flex items-center justify-center gap-3 px-4 py-3 bg-stone-50 border border-stone-200 rounded-2xl hover:bg-stone-100 transition-colors">
