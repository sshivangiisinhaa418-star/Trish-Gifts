        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center px-4 sm:px-8 py-12 lg:py-0">
          ...
          <div className="w-full max-w-lg bg-white/95 backdrop-blur-2xl p-10 md:p-12 rounded-[2.5rem] border border-white/60 shadow-[0_20px_40px_-15px_rgba(0,0,0,0.1)] hover:shadow-[0_30px_60px_-15px_rgba(0,0,0,0.15)] transition-shadow duration-500 animate-fade-up">
              ...
              <div>
                <div className="flex items-center justify-between">
                  <label className="flex items-center gap-2">
                    <input type="checkbox" className="w-4 h-4 rounded border-gray-300 text-[#500000] focus:ring-[#500000]" />
                    <span className="text-xs text-gray-500">Remember me</span>
                  </label>
                  <Link href="/concierge" className="text-xs text-[#500000] hover:underline">Forgot Password?</Link>
                </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <button type="button" onClick={() => handleOAuthLogin('google')} className="flex items-center justify-center gap-3 px-4 py-3 bg-stone-50 border border-stone-200 rounded-2xl hover:bg-stone-100 transition-colors">
              ...
              <button type="button" onClick={() => handleOAuthLogin('apple')} className="flex items-center justify-center gap-3 px-4 py-3 bg-stone-50 border border-stone-200 rounded-2xl hover:bg-stone-100 transition-colors">
            ...
            <p className="mt-8 text-center text-sm text-gray-500 font-light">
              Don't have an account? <Link href="/signup" className="font-bold text-gray-900 hover:text-[#500000] hover:underline transition-colors">Create one here</Link>
            </p>
          </div>
        </div>
      </div>
